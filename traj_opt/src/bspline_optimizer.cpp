...
const int BsplineOptimizer::SMOOTHNESS  = (1 << 0);  // 0000 0001
const int BsplineOptimizer::DISTANCE    = (1 << 1);  // 0000 0010
const int BsplineOptimizer::FEASIBILITY = (1 << 2);  // 0000 0100
const int BsplineOptimizer::ENDPOINT    = (1 << 3);  // 0000 1000
const int BsplineOptimizer::GUIDE       = (1 << 4);  // 0001 0000
const int BsplineOptimizer::WAYPOINTS   = (1 << 6);  // 0100 0000
...
Eigen::MatrixXd BsplineOptimizer::BsplineOptimizeTraj(const Eigen::MatrixXd& points,
                                                      const double&          ts,
...
void BsplineOptimizer::optimize() {
  ...
  const int pt_num = control_points_.rows();  // all of the initial control points
  g_q_.resize(pt_num);

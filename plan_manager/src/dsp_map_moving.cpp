...
void poseCallback(const ros::TimerEvent &e) { /* Publish control commands */
  pose_count_++;
  /* ----- moving logic ----- */
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "moving_dsp_map_node");
  ros::NodeHandle nh("~");
  ...
  pose_count_ = 0;  // controller: initialize pose count

 ...
 * @param msg
 */
void FiniteStateMachine::PoseCallback(const geometry_msgs::PoseStampedPtr& msg) {
  if (!is_state_locked_) {
 ...
 */
void FiniteStateMachine::visCallback(const ros::TimerEvent& event) {
 ...
 * @param msg
 */
void FiniteStateMachine::clickCallback(const geometry_msgs::PoseStamped::ConstPtr& msg) {

/**
 * @file vis_kinodyn_a_star_node.cpp
...
#include <path_searching/kinodynamic_a_star.h>
...
int main(int argc, char **argv) {
  ...
  a_star_.reset(new KinodynamicAstar());
  a_star_->setParam(nh);
  a_star_->setEnvironment(grid_map_);
  a_star_->init(Eigen::Vector3d(0, 0, 1), Eigen::Vector3i(pool_size_x, pool_size_y, pool_size_z));
